...
> Последнее обновление: 2026-03-27 (статус в view, редактирование даты, нейминг актов, Электричество/Вентиляция/Общие замечания, фото для "Прочее", PDF: без "Прочее:" и без автоединиц, стилизация блока "Общие замечания" → room-block)
